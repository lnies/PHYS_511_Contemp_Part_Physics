...
plot \
	"ze_5ns.txt" using (hist($0,width)):($1) smooth freq w boxes ls 1 title "5ns", \
	"ze_10ns.txt" using (hist($0,width)):($1) smooth freq w boxes ls 2 title "10ns", \
	"ze_15ns.txt" using (hist($0,width)):($1) smooth freq w boxes ls 3 title "15ns", \
	"ze_20ns.txt" using (hist($0,width)):($1) smooth freq w boxes ls 4 title "20ns", \
	"ze_25ns.txt" using (hist($0,width)):($1) smooth freq w boxes ls 5 title "25ns", \
	"ze_30ns.txt" using (hist($0,width)):($1) smooth freq w boxes ls 6 title "30ns", \
	"ze_35ns.txt" using (hist($0,width)):($1) smooth freq w boxes ls 7 title "35ns", \

...
set xlabel "Energy [keV]" offset 0 font "Arial, 32"
#set x2label "Time [ps]"
...
plot \
	"ba25gC_1.txt" using (eichung1((hist($0,width)))):($1/norm_ba_1) smooth freq w boxes ls 1 title "133Ba 25gC", \
	"ba-25gC_1.txt" using (eichung2((hist($0,width)))):($1/norm_ba_2) smooth freq w boxes ls 4 title "133Ba -25gC", \

...
plot \
	"cs25gC_1.txt" using (eichung1((hist($0,width)))):($1/norm_cs_1) smooth freq w boxes ls 1 title "22Na 25gC", \
	"cs-25gC_1.txt" using (eichung2((hist($0,width)))):($1/norm_cs_2) smooth freq w boxes ls 4 title "22Na -25gC", \

...
plot \
	"co-25gC_test3.txt" using (hist($0,width)):($1/norm_cs_1) smooth freq w boxes ls 4 title "60Co -25 °C", \
	"co-25gC_test3.txt" using (hist($0,width)):($1/norm_cs_1) smooth freq w histeps ls 4 lw 2 notitle, \

...
plot \
	"eu25gC_1.txt" using (hist($0,width)):($1/norm_cs_1) smooth freq w boxes ls 2 title "152Eu 25 °C", \
	"eu25gC_1.txt" using (hist($0,width)):($1/norm_cs_1) smooth freq w histeps ls 2 lw 2 notitle

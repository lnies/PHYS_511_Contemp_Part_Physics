...
plot \
	"ba-25gC_1.txt" using (hist($0,width)):($1/norm_cs_1) smooth freq w boxes ls 1 title "133Ba -25 °C", \
	"ba-25gC_1.txt" using (hist($0,width)):($1/norm_cs_1) smooth freq w histeps ls 1 lw 2 notitle, \

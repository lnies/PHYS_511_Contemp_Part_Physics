...
set xrange [0:3000]
set x2range [eichung(0):eichung(3000)]
set x2tics
...
plot \
	"eu-25gC_1.txt" using (hist($0,width)):($1/norm_cs_1) smooth freq w boxes ls 2 title "152Eu -25 °C", \
	"eu-25gC_1.txt" using (hist($0,width)):($1/norm_cs_1) smooth freq w histeps ls 2 lw 2 notitle, \

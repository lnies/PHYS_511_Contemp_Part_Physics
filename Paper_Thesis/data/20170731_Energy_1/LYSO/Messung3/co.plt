...
plot \
	"co25gC_2.txt" using (eichung1((hist($0,width)))):($1/norm_co_1) smooth freq w boxes ls 1 title "60Co 25gC", \
	"co-25gC_1.txt" using (eichung2((hist($0,width)))):($1/norm_co_2) smooth freq w boxes ls 4 title "60Co -25gC", \

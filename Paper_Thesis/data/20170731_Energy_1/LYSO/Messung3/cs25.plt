...
plot \
	"cs25gC_1.txt" using (hist($0,width)):($1/norm_cs_1) smooth freq w boxes ls 6 title "137Cs 25 °C", \
	"cs25gC_1.txt" using (hist($0,width)):($1/norm_cs_1) smooth freq w histeps ls 6 lw 2 notitle

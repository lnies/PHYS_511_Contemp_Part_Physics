...
plot \
	"na-25gC_1.txt" using (hist($0,width)):($1/norm_cs_1) smooth freq w boxes ls 5 title "22Na -25 °C", \
	"na-25gC_1.txt" using (hist($0,width)):($1/norm_cs_1) smooth freq w histeps ls 5 lw 2 notitle, \

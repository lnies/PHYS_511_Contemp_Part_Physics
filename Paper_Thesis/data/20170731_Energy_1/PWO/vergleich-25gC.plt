...
plot \
	"co-25gC_3.txt" using (hist($0,width)):(log($1/norm_ba)) smooth frequency with histeps ls 4 title "60Co -25gC", \
	"na-25gC_1.txt" using (hist($0,width)):(log($1/norm_na)) smooth frequency with histeps ls 5 title "22Na -25gC", \
	"cs-25gC_1.txt" using (hist($0,width)):(log($1/norm_cs)) smooth frequency with histeps ls 6 title "137Cs -25gC", \
	"unter-25gc_1.txt" using (hist($0,width)):(log($1/norm_cs)) smooth frequency with histeps ls 1 title "Untergrund -25gC", \

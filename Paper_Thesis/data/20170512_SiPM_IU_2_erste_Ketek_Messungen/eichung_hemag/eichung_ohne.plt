...
fit [2:40] eichung(x) "eichung_hameg.txt" using 1:3 via slope, offset

set label 1 sprintf("m = %1.5f",slope) at 5,25 font "Arial, 18"
set label 2 sprintf("y_0 = %1.5f",offset) at 5,23 font "Arial, 18"


plot \
	eichung(x) title "Eichung U_A=m*U_{In}+y_0" lw 2, \
	"eichung_hameg.txt" using 1:3 title "Datenpunkte" ps 1.0 pt 4 w lp

...
set title "Vergleich 1x1n1 und 1x1n2 ohne Quelle, unbestrahlt"
...
plot \
	"iu_curve_1x1n2_wos_0dose.txt" using 2:(log($3)) title "1x1n2", \
	"iu_curve_1x1n1_wos_0gray_N1n1loop.txt." using 2:(log($3)) title "1x1n1"

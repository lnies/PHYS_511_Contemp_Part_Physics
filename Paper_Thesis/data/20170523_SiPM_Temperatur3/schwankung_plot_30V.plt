...
set y2range [10.0:30.0]
set grid 
set y2tic

set title "Spannungs- und Temperaturschwankungen bei U=30.8V"
set xlabel "Messpunkt"
set ylabel "Spannung [V]"
set y2label "Temperatur [gC]"

plot \
	"test2.txt" using 0:3 title "Spannung bei U=30.8V", \
	"test2.txt" using 0:4 axes x1y2 smooth bez lw 3 title "Temperatur"

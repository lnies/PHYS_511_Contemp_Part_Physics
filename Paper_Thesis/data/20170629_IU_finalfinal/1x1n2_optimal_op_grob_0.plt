...
set style line 1 lc "blue" lt 1 lw 2 pt 9 ps 1 pi 2
...
fit [x_min:x_max] pol2(x) "iu_curve_1x1n2_grob_0gC_der.txt" using 1:4 via A,B,C
...
plot \
	"iu_curve_1x1n2_grob_0gC_der.txt" using 1:4 with lp ls 1 title "0 {/Symbol \260}C", \

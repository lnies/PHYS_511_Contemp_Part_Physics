...
set style line 1 lc "yellow" lt 1 lw 3 pt 9 ps 3 pi 2
...
fit [x_min1:x_max1] pol1(x) "iu_curve_4x1n6_15gC.txt" using 2:(log10($3-yoffset)) via m,y0
fit [x_min2:x_max2] pol2(x) "iu_curve_4x1n6_15gC.txt" using 2:(log10($3-yoffset)) via A,B,C
...
plot \
	"iu_curve_4x1n6_15gC.txt" using 2:(log10($3-yoffset)) with lp ls 1 title "15 {/Symbol \260}C", \

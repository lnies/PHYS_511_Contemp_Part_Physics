...
fit pol1(x) "4x1n6_fits.txt" using 1:2:3 via m1,y1 
fit pol2(x) "4x1n6_fits.txt" using 1:4:5 via m2,y2 

plot \
	"4x1n6_fits.txt" using 1:2:3 w yerr lw 5 lc "blue" title "Operation Voltage", \
	"4x1n6_fits.txt" using 1:4:5 w yerr lw 5 lc "red" title "Breakdown Voltage", \

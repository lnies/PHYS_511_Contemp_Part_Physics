...
fit [x_min1:x_max1] pol1(x) "iu_curve_4x1n6_25gC.txt" using 2:(log10($3-yoffset)) via m,y0
fit [x_min2:x_max2] pol2(x) "iu_curve_4x1n6_25gC.txt" using 2:(log10($3-yoffset)) via A,B,C
...
plot \
	"iu_curve_4x1n6_25gC.txt" using 2:(log10($3-yoffset)) with lp ls 1 title "25 {/Symbol \260}C", \
	pol1(x) lw 5 lc "green" title "1st order fit", \
	pol2(x) lw 5 lc "blue" title "2nd order fit"

...
fit [x_min:x_max] pol2(x) "iu_curve_1x1n2_grob_-25gC_der.txt" using 1:4 via A,B,C
...
plot \
	"iu_curve_1x1n2_grob_-25gC_der.txt" using 1:4 with lp ls 1 title "-25 {/Symbol \260}C", \

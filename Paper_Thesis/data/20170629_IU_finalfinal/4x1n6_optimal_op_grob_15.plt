...
fit [x_min:x_max] pol2(x) "iu_curve_4x1n6_grob_15gC_der.txt" using 1:4 via A,B,C
...
plot \
	"iu_curve_4x1n6_grob_15gC_der.txt" using 1:4 with lp ls 1 title "15 {/Symbol \260}C", \

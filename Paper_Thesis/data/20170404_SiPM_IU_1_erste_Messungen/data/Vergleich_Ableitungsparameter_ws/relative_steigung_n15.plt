...
fit [58:68] pol(x) "iu_curve_loop_n20_n15_der.txt" using 1:((0.991*$3+0.12)/$2) via a, b, c
...
plot \
	"iu_curve_loop_n20_n15_der.txt" using 1:((0.991*$3+0.12)/$2) title "n = 15" ps 1.0 pt 4 w lp, \

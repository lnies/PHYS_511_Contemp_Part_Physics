...
fit [55:68] pol(x) "iu_curve_wo_source_n20_n31_600_der.txt" using 1:((0.991*$3+0.12)/$2) via a, b, c
...
plot \
	"iu_curve_wo_source_n20_n31_600_der.txt" using 1:((0.991*$3+0.12)/$2) title "n = 31" ps 1.0 pt 4 w lp, \

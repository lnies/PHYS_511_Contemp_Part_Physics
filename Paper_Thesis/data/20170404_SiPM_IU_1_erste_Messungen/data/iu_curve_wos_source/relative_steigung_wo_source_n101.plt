...
pol(x) = ( x > 55 && x < 68 ) ? a * x**2 + b * x + c : 1/0

a = 1
b = 1
c = 1

fit [55:68] pol(x) "iu_curve_wo_source_n20_n101_600_der.txt" using 1:((0.991*$3+0.12)/$2) via a, b, c
...
plot \
	"iu_curve_wo_source_n20_n101_600_der.txt" using 1:((0.991*$3+0.12)/$2) title "n = 101" ps 1.0 pt 4 w lp, \

...
#fit [0:53.25] lin(x) "iu_curve_Wien_sipm_4_tstable.txt" using 2:(log($3)) via m,y0
#fit [53.30:57] pol(x) "iu_curve_Wien_sipm_4_tstable.txt" using 2:(log($3)) via a,b,c
...
plot \
	"iu_curve_Wien_sipm_4_tstable.txt" using 2:3 lc "blue" lw 1 title "Data SiPM#4" with lp, \

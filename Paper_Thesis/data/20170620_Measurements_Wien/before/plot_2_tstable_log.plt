...
set title "IV-Curve SiPM #2 (Logscale)"
...
fit [0:52.5] lin(x) "iu_curve_Wien_sipm_2_tstable.txt" using 2:(log($3)) via m,y0
fit [52.5:53.7] pol(x) "iu_curve_Wien_sipm_2_tstable.txt" using 2:(log($3)) via a,b,c

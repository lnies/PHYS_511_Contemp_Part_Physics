...
#fit [0:53.25] lin(x) "iu_curve_Wien_sipm_1_tstable.txt" using 2:(log($3)) via m,y0
#fit [53.30:57] pol(x) "iu_curve_Wien_sipm_1_tstable.txt" using 2:(log($3)) via a,b,c
...
plot \
	"iu_curve_Wien_sipm_2_tstable.txt" using 2:3 lc "orange" lw 1 title "Data SiPM#2" with lp, \

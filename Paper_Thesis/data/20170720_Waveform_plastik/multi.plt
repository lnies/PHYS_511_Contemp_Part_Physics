...
plot \
	"C2singlewave00000.txt" using ($1*1e9+t_single):($2*1e3/norm_single) ls 1 title "Single" ,\
	"C2hybridwave00000.txt" using ($1*1e9+t_hybrid):($2*1e3/norm_hybrid) ls 2 title "Hybrid" ,\

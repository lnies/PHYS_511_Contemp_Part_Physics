...
fit [27:31.7] pol(x) "iu_curve_1x1n2_20gC_n100samples_der.txt" using 1:4 via a, b, c
...
plot \
	"iu_curve_1x1n2_20gC_n100samples_der.txt" using 1:4 title "iu_curve_1x1n2_wos_25gray_N1n100loop_20gC" ps 1.0 pt 4 w lp, \

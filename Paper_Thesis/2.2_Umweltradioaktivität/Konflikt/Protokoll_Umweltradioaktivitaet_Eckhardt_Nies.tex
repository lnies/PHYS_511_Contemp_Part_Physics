...
\begin{document}
	...
	\end{figure}
	\vspace*{0.1cm}
	\textbf{Institut f"ur Atom- und Molek"ulphysik\\} 	
	}
...
Grund daf"ur ist die Eigenschaft der Radioaktivit"at, ionisierende Strahlung freizusetzen, die sch"adigend auf Lebewesen wirkt. Dies mussten nicht nur die Naturforscher \textit{Pierre} und \textit{Marie Curie} an ihrer eigenen Gesundheit erfahren, auch viele weiter Menschen sind seit der Erforschung und der daraus resultierenden Techniken mit erh"ohter Strahlenbelastung konfrontiert worden. \par 
...
Radioaktive Strahlung entsteht haupts"achlich bei der Umwandlung von Kernen, \colorbox{yellow}{dies versteht man unter Radioaktivit"at}. Dabei unterscheidet man zwischen verschiedenen Strahlungsarten, die physikalisch grundverschieden sind.
...
\begin{wrapfigure}{r}[2cm]{0.6\textwidth}
	\centering
	\includegraphics[width=0.5\textwidth]{./hl.png}
...
Das Untergrundspektrum des Praktikumsraumes wurde insgesamt f"ur t$=\SI{234961}{\second}\approx\SI{65.3}{\hour}$ aufgenommen. In Tabelle \ref{tab:untergrund} sind die deutlichsten Peaks des Untergrundes eingetragen und wie im vorherigen Teil die Energien mit Hilfe der Eichung \eqref{eq:energie} und der Fehlerrechnung \eqref{eq:fehler} umgerechnet. Im Plot \ref{fig:untergrund} ist der Untergrund (gr"un) im Vergleich zum Gl"uhstrumpf (blau) gezeichnet.   
...
\begin{table}[h!]
	...
	\makebox[\textwidth]{
		\begin{tabular}{cccccccc}
			...
			\rowcolor[rgb]{ .949,  .949,  .949} 2547.08 & 0.02502 & 1063.88295 & 0.03426 & 207Bi & 1063.10000 & 0.78295 & / \\
			...
			\rowcolor[rgb]{ .949,  .949,  .949} 1362.12 & 0.02241 & 569.90808 & 0.02180 & 134Cs & 570.82600 & 0.91792 & / \\
...
\begin{table}[h]
	...
	\makebox[\textwidth]{
		\begin{tabular}{c|cccc}
			...
			A  & $\SI{5752.0\pm 170}{\becquerel}$ & $\SI{173.73\pm 5.13}{\gram}$  & $\SI{190.52}{\gram}$  & -8.8\%  \\
			B & $\SI{5580.6\pm 131.1}{\becquerel}$ & $\SI{168.55\pm 3.96}{\gram}$ & $\SI{183.0}{\gram}$ & -7.9\% \\  
		\end{tabular}%
	}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{./20161216/probanden.png}
